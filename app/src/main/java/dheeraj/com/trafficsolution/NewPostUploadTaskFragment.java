...
public class NewPostUploadTaskFragment extends Fragment {
    ...
    public void uploadPost(Bitmap bitmap, String inBitmapPath, Bitmap thumbnail, String inThumbnailPath,
                           String inFileName, String inPostText, String tags) {
        UploadPostTask uploadTask = new UploadPostTask(bitmap, inBitmapPath, thumbnail, inThumbnailPath, inFileName, inPostText,tags);
        uploadTask.execute();
    }
    ...
    class UploadPostTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            StorageReference photoRef = storageRef.getReferenceFromUrl("gs://trafficapp-43fae.appspot.com");
                    ...
                    thumbnailRef.putBytes(thumbnailStream.toByteArray())
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Post newPost = new Post(author, fullSizeUrl.toString(), fullSizeRef.toString(),
                                    thumbnailUrl.toString(), thumbnailRef.toString(), postText, ServerValue.TIMESTAMP,Tags);
