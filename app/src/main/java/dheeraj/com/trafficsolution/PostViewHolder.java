...
public class PostViewHolder extends RecyclerView.ViewHolder {
    ...
    public EditTag tagview;

    public PostViewHolder(View itemView) {
        super(itemView);
        mView = itemView;
        mPhotoView = (ImageView) itemView.findViewById(R.id.post_photo);
        mIconView = (CircularImageView) mView.findViewById(R.id.post_author_icon);
        ...
        tagview = (EditTag)itemView.findViewById(R.id.tag_view);
